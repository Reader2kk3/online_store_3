...
'''
    С помощью декоратора @shared_task определяется задание payment_com-
    pleted. В этом задании используется предоставляемый веб-фреймворком
    ...
    представляет собой резидентный байтовый буфер. Затем с помощью метода
